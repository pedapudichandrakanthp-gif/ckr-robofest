        ...
        <div className="grid lg:grid-cols-2 gap-6 lg:gap-16 items-center">
          ...
          <div className="relative order-1 lg:order-2">
            <div className="relative aspect-[4/3] lg:aspect-square rounded-xl lg:rounded-2xl border border-ckr-gold/20 bg-ckr-black overflow-hidden shadow-2xl shadow-ckr-gold/10">
              {/* Future media slot: replace the abstract stage below with an approved CKR image or video element. */}
              <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_18%,rgba(212,175,55,0.22),transparent_34%),linear-gradient(145deg,rgba(45,45,45,0.95),rgba(10,10,10,1)_62%)]"></div>
              ...
              <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-6 lg:p-8">
                <div className="rounded-xl border border-ckr-gold/30 bg-ckr-black/75 p-3 sm:p-4 backdrop-blur-md shadow-xl shadow-ckr-black/40">
                  ...
                  <p className="text-ckr-light-gray text-[10px] sm:text-xs">Placeholder stage for approved robot photos, demos, and CKR event media.</p>
                </div>
              </div>
